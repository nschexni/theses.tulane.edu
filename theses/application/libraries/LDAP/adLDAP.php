...
class adLDAP {
    ...
    * @var string
    */
	protected $baseDn = "ou=Accounts,dc=tcs,dc=tulane,dc=edu"; 
    ...
    * @var array
    */
    protected $domainControllers = array("ldapauth.tcs.tulane.edu");
    ...
    */
    public function authenticate($username, $password, $preventRebind = false) {
        ...
        // Bind as the user        
        $ret = true;
        $this->ldapBind = @ldap_bind($this->ldapConnection, 'cn=' . $username . ',' . $this->baseDn, $password);
        if (!$this->ldapBind){ 
            $ret = false; 
        }
