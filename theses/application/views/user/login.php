            ...
            <?= form_open() ?>
              ...
              <div id="best_experienced" class="span8">
                ...
                <a href="http://www.mozilla.org/en-US/firefox/fx/" target="_blank">
                    <img src="<?=base_url() ?>assets/img/icons/mozilla_firefox_logo_100.png" width="60px" alt="mozilla firefox browser"/> 
                </a>
                <a href="https://www.google.com/chrome" target="_blank">
                    <img src="<?= base_url() ?>assets/img/icons/chrome_logo.png" width="60px" alt="google chrome browser"/>  
                </a>    
            </div>
